select right1.nguid_rdcl, right1.label, right1.add_l_from::int, right1.add_l_to::int, right2.nguid_rdcl, right2.label, right2.add_l_from::int, right2.add_l_to::int
