#-------------------------------------------------------------------------------
# Name:        Okprep_PROV.py
# Purpose:     Converts ArcGIS field inputs from an ProvisioningBoundary Polygon layer to correct field names.
#
# Author:      Baker (OK)
#
...
def main():
    ...
    correct_name = "DISCREPANCYAGENCY_BOUNDARY"

    session = NG911_Session(output_gdb)
    fields_folder = session.fieldsFolderPath
    file_name = "DISCREPANCYAGENCY_BOUNDARY.txt"
