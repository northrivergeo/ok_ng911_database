#-------------------------------------------------------------------------------
# Name:        Okprep_ESZ_Boundary.py
# Purpose:     Converts ArcGIS field inputs from an ESZ_Boundary Polygon layer to correct field names.
#
