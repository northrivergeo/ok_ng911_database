#-------------------------------------------------------------------------------
# Name:        Okprep_MUNI.py
# Purpose:     Converts ArcGIS field inputs from an ESB_FIRE_Boundary Polygon layer to correct field names.
#
